...
public class DataTest extends MultiSessionBrowserTest {
    ...
    @Test(description = "Check something with vary data", dataProvider = "csvData", enabled = false)
    public void checkSomethingWithData(Map<String, String> data) {
        log.info("Test something with data {}", data);
    }

    @Test(description = "Check something with vary data", dataProvider = "excelData", enabled = false)
    ...
    @Test(description = "Check something with vary data", dataProvider = "jsonData", enabled = false)
